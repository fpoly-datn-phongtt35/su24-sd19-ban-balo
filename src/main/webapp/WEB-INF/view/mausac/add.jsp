...
<form action="/mausac/add" method="post" onsubmit="return kt()">
    <table>
        <div class="col-mt-3">
            <div class="col-6">
                <label>maMauSac</label>
                <input type="text" name="maMauSac" id="maMauSac" class="form-control">
            </div>
            <div class="col-6">
                <label>tenMauSac</label>
                <input type="text" name="tenMauSac" id="tenMauSac" class="form-control">
            </div>
            <div class="col-6">
                <label>ngayTao</label>
