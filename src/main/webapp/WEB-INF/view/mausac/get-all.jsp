...
<table class="table table-primary table-striped table-hover">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item"><a class="page-link" href="/mausac/hien-thi?page=${list.number - 1}">Truoc</a></li>
            <li class="page-item"><a class="page-link" href="#">${list.number}</a></li>
            <li class="page-item"><a class="page-link" href="/mausac/hien-thi?page=${list.number + 1}">Sau</a></li>
        </ul>
    </nav>
</table>
<footer>
