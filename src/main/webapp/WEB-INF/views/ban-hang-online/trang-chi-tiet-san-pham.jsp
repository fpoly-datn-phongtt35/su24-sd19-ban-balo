...
<head>
    ...
    <link rel="styleshe et" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <meta charset="utf-8">
                            ...
                            <c:if test="${idkhachhang!='1'}">
                                <c:if test="${listghct.size()>0}">
                                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                        <img src="../../../images/shopping%20cart.jpg"
                                             width="20" height="20">
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class=" main-nav nav ">
                    ...
                    <li><a href="/ban-hang-online/balo">SẢN PHẨM</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="margin-top: 6cm">
                                            ...
                                            <table class="product-info-table">
                                                ...
                                                <tr>
                                                    <td class="info-label">Trọng lượng:</td>
                                                    <td>${motctsp.trongLuong.ten}</td>
                                                </tr>
                                                <tr>
...
color: white;border-radius: 5% 5% 5% 5%"
    ...
    <h2 style="color: white;font-size: 20px;margin-top: 20px">
        Chỉ chấp nhận giá trị đơn hàng<br><= 10.000.000
    </h2>
</div>
<script>
    // /////////////////////////////////////////
