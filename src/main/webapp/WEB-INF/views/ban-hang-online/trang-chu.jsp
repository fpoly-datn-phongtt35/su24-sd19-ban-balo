            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="header-logo">
                        <h2  class="logo" style="margin: 20px;color: black;font-family: 'Arial'">KING
                            SHOP</h2>
                    </div>
                </div>
                <!-- /LOGO -->
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../../img/banner/banner1.png" class="d-block w-100" width="720" height="420">
                </div>
                ...
                <div class="carousel-item">
                    <img src="../../../img/banner/banner1.png" class="d-block w-100" width="720" height="320">
                </div>
            </div>
