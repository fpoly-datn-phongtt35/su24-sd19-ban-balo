    ...
    <c:forEach items="${listhdct}" var="ht" varStatus="stt">
        <c:if test="${stt.index==0}">
            <tr>
                <td>${ht.hoaDon.ma}</td>
                <td>
                    <img src="../../../uploads/${ht.idChiTietSanPham.hinhAnh.tenAnh}" width="40" height="40"
                         style="border-radius:50% 50% 50% 50%">
                </td>
                <td>
                        ${ht.idChiTietSanPham.sanPham.ten} - ${ht.idChiTietSanPham.mauSac.ten}
                    - ${ht.idChiTietSanPham.kichCo.ten} - ${ht.idChiTietSanPham.thuongHieu.ten}.
                </td>
                <td>
                        ${ht.phantram()}%
                </td>
                ...
                <td>
                        ${banhangonline.listIMEItheoIDHDvsIDCTSP(ht.hoaDon.id,ht.idChiTietSanPham.id).size()}
                </td>
                <td>${banhangonline.dongiaVSsoluongXemHDCT(ht.hoaDon.id,ht.idChiTietSanPham.id)}
                    VND
                </td>
                <td>
