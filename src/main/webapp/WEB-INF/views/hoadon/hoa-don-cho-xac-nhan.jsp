    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul  class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="description-tab" data-toggle="tab" href="/hoa-don/cho-xac-nhan" role="tab"
                       aria-controls="description" aria-selected="false">Chờ xác nhận</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        <div class=" col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/hoa-don/loc-cho-xac-nhan" method="post" modelAttribute="hoaDon">
                                ...
                                <div align="center">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            <c:forEach items="${listHoaDonChoXacNhan}" var="CXN" varStatus="i">
                                                <tr>
                                                    <td>${i.index+1}</td>
                                                    <td>${CXN.ma}</td>
                                                    <td>${CXN.tenNguoiNhan}</td>
                                                    <td>${CXN.tongTien}</td>
                                                    <td>${CXN.ngayTao}</td>
                                                    <td>
                                                        <c:if test="${CXN.loaiHoaDon == 0}">Tại quầy</c:if>
                                                        <c:if test="${CXN.loaiHoaDon == 1}">Online</c:if>
                                                    </td>
                                                    <td>
                                                        <c:if test="${CXN.trangThaiGiaoHang == 1}">Chờ xác nhận</c:if>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn mb-1  btn-outline-primary">
                                                            <a href="/hoa-don/detail/${CXN.id}">Xem</a></button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
