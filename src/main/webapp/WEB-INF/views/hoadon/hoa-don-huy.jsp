    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="description-tab" data-toggle="tab" href="/hoa-don/huy"
                       role="tab" aria-controls="description" aria-selected="false">Huỷ</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        <div class=" col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/hoa-don/loc-huy" method="post" modelAttribute="hoaDon">
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <c:forEach items="${listHoaDonHuy}" var="huy" varStatus="i">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${huy.trangThaiGiaoHang == 5}"> Đã huỷ</c:if>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn mb-1  btn-outline-primary">
                                                        <a href="/hoa-don/detail/${huy.id}">Xem</a></button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
