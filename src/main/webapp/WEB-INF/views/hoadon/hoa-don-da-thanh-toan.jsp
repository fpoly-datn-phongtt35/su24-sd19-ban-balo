    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul  class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="description-tab" data-toggle="tab" href="/hoa-don/da-xac-nhan" role="tab"
                       >Đã xác nhận</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/hoa-don/da-thanh-toan" role="tab"
                       aria-controls="description" aria-selected="false" >Đã thanh toán</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        <div class=" col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/hoa-don/loc-da-thanh-toan" method="post" modelAttribute="hoaDon">
                                ...
                                <div align="center">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            <c:forEach items="${listHoaDonDaThanhToan}" var="DXN" varStatus="i">
                                                <tr>
                                                    <td>${i.index+1}</td>
                                                    <td>${DXN.ma}</td>
                                                    <td>${DXN.tenNguoiNhan}</td>
                                                    <td>${DXN.tongTien}</td>
                                                    <td>${DXN.ngayTao}</td>
                                                    <td>
                                                        <c:if test="${DXN.loaiHoaDon == 0}">Tại quầy</c:if>
                                                        <c:if test="${DXN.loaiHoaDon == 1}">Online</c:if>
                                                    </td>
                                                    <td>
                                                        <c:if test="${DXN.trangThaiHoaDon == 4}">Đã Thanh Toán</c:if>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn mb-1  btn-outline-primary">
                                                            <a href="/hoa-don/detail/${DXN.id}">Xem</a></button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
