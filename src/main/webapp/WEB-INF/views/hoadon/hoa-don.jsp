                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        <div class=" col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/hoa-don/loc-tong" method="post" modelAttribute="hoaDon">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/hoa-don/da-thanh-toan" role="tab"
                                    >Đã thanh toán</a>
                                </li>
                                <li class="nav-item">
        ...
        <table class="table table-striped table-bordered zero-configuration">
            ...
            <c:forEach items="${listHoaDonAll}" var="All" varStatus="i">
                <tr>
                    <td>${i.index+1}</td>
                    <td>${All.ma}</td>
                    <td>${All.khachHang.hoTen}</td>
                    <td>
                        <c:if test="${All.hinhThucThanhToan==1 && All.loaiHoaDon == 1}">
                            <script>
                                var donGia = ${All.tongTien};
                                document.write(donGia.toLocaleString('vi-VN'));
                            </script>
                        </c:if>
                        <c:if test="${All.hinhThucThanhToan==0 && All.loaiHoaDon == 1}">
                            <script>
                                var donGia = ${All.tongTien + 25000};
                                document.write(donGia.toLocaleString('vi-VN'));
                            </script>
                        </c:if>
                        <c:if test="${All.loaiHoaDon == 0}">
                            <script>
                                var donGia = ${All.tongTien};
                                document.write(donGia.toLocaleString('vi-VN'));
                            </script>
                    ...
                    <td>
                        <c:if test="${All.trangThaiHoaDon == 0}"> Chờ Xác nhận</c:if>
                        <c:if test="${All.trangThaiHoaDon == 1}"> Xác nhân</c:if>
                        ...
                        <%--                                                </td>--%>
                    <td>
                        <a type="button" class="btn mb-1  btn-outline-primary"
                            <%--                                                            onclick="if((confirm('Bạn có muốn thực hiện thao tác này không ? ')));">--%>
                        <a href="/hoa-don/detail/${All.id}">Xem</a>
                        </a>
