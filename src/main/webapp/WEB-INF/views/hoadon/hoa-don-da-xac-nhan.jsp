    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul  class="nav nav-pills mb-3" id="setting-panel" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="description-tab" data-toggle="tab" href="/hoa-don/da-xac-nhan" role="tab"
                       aria-controls="description" aria-selected="false">Đã xác nhận</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        <div class=" col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/hoa-don/loc-da-xac-nhan" method="post" modelAttribute="hoaDon">
                                ...
                                <div align="center">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                            <c:forEach items="${listHoaDonDaXacNhan}" var="DXN" varStatus="i">
                                                <tr>
                                                    <td>${i.index+1}</td>
                                                    <td>${DXN.ma}</td>
                                                    ...
                                                    <td>
                                                        <c:if test="${DXN.trangThaiGiaoHang == 2}">Đã xác nhận</c:if>
                                                    </td>
                                                    <td>
