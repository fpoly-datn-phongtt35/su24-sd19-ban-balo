        ...
        <div class="card-body">
            <div>
                <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/kich-co/view-add" role="tab" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Thêm
                            thông tin
                            kích cỡ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/kich-co/hien-thi-delete" role="tab" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <%--            Tìm kiếm               --%>
                                <form action="/kich-co/search-con-hoat-dong" method="post">
                                    ...
                                    <table class="table table-striped" style="color: black">
                                        ...
                                        <c:forEach items="${listKichCo}" var="kichCo" varStatus="index">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/kich-co/detail/${kichCo.id}"
                                                       ...
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        ...
                                                        Detail</a>
                                                    <a href="/kich-co/view-update/${kichCo.id}"
                                                       class="btn btn-warning btn-icon-text"
                                                       tabindex="-1"
                                                       role="button"
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        <i class="ti-file btn-icon-prepend"></i>
                                                        Update</a>
                                                    <a href="/kich-co/delete/${kichCo.id}"
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center pagination-lg">
                                                <c:forEach begin="1" end="${totalPage}" varStatus="status">
                                                    <li class="page-item">
                                                        <a href="/kich-co/hien-thi?pageNum=${status.index -1}"
...
<button style="display: none" type="button" id="batmodalupdatekichco" class="btn btn-primary" data-bs-toggle="modal"
        data-bs-target="#updateKichCo">
    Open modal
</button>
<div class="modal" id="updateKichCo">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body" style="color: black">
                <form:form action="/kich-co/update/${kichCo.id}" method="post" modelAttribute="kichCo">
                    <div class="form-group">
                        <form:label class="form-label" path="ma">Mã kích cỡ:</form:label>
                        <form:input class="form-control" path="ma" readonly="true"/>
                        <form:errors path="ma" cssStyle="color: red"></form:errors>
...
<script>
    <c:if test="${batmodalupdatekichco==0}">
    document.getElementById('batmodalupdatekichco').click();
    </c:if>
</script>
</html>
