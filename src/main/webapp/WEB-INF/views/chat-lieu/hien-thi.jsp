                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <%--            Tìm kiếm               --%>
                                <form action="/chat-lieu/search-con-hoat-dong" method="post">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" style="color: black">
                                        ...
                                        <c:forEach items="${listChatLieu}" var="chatLieu" varStatus="index">
                                            <tr>
                                                ...
                                                <td>${chatLieu.ten}</td>
                                                <td>
                                                    <c:if test="${chatLieu.trangThai==0}">Còn sử dụng</c:if>
                                                    <c:if test="${chatLieu.trangThai==1}">Ngừng sử dụng</c:if>
                                                </td>
                                                <td>${chatLieu.ngayTao}</td>
                                                <td>
                                                    <a href="/chat-lieu/detail/${chatLieu.id}"
                                                       ...
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        ...
                                                        Detail</a>
                                                    <a href="/chat-lieu/view-update/${chatLieu.id}"
                                                       class="btn btn-warning btn-icon-text"
                                                       tabindex="-1"
                                                       role="button"
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        <i class="ti-file btn-icon-prepend"></i>
                                                        Update</a>
                                                    <a href="/chat-lieu/delete/${chatLieu.id}"
                                    ...
                                    <c:if test="${not listChatLieu.isEmpty()}">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center pagination-lg">
                                                <c:forEach begin="1" end="${totalPage}" varStatus="status">
                                                    <li class="page-item">
                                                        <a href="/chat-lieu/hien-thi?pageNum=${status.index -1}"
...
<button style="display: none" type="button" id="batmodaldetailchatlieu" class="btn btn-primary" data-bs-toggle="modal"
        ...
        <div class="modal-content">
            <div class="modal-body" style="color: black">
                <form:form method="post" modelAttribute="chatLieu">
                    <div class="form-group">
                        <form:label class="form-label" path="ma">Mã chất liệu:</form:label>
...
<button style="display: none" type="button" id="batmodalupdatechatlieu" class="btn btn-primary" data-bs-toggle="modal"
