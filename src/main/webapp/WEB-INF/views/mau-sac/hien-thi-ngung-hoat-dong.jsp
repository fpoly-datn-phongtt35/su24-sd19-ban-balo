        ...
        <div class="card-body">
            <div>
                <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" href="/mau-sac/hien-thi" role="tab" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Thông
                            tin màu sắc</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
                           aria-controls="description" aria-selected="true">Thông tin màu sắc ngưng sử dụng</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <%--            Tìm kiếm               --%>
                                <form action="/mau-sac/search-ngung-hoat-dong" method="post">
                                    ...
                                    <table class="table table-striped" style="color: black">
                                        ...
                                        <c:forEach items="${listMauSac}" var="mauSac" varStatus="index">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/mau-sac/detail-ngung-hoat-dong/${mauSac.id}"
                                                       ...
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        ...
                                                        Detail</a>
                                                    <a href="/mau-sac/khoi-phuc/${mauSac.id}"
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center pagination-lg">
                                                <li class="page-item"><a class="page-link"
                                                                         href="/mau-sac/hien-thi-delete?pageNum=0"><<</a>
                                                </li>
                                                <c:forEach begin="1" end="${totalPage}" varStatus="status">
                                                    <li class="page-item">
                                                        <a href="/mau-sac/hien-thi-delete?pageNum=${status.index -1}"
                                                           class="page-link">${status.index}</a>
                                                    </li>
                                                </c:forEach>
                                                <li class="page-item"><a class="page-link"
                                                                         href="/mau-sac/hien-thi-delete?pageNum=${total-1}">>></a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </c:if>
