                        ...
                        <div class="row" style="color: black">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-11">
                                            <form:select path="trongLuong" class="form-control" id="selectTrongLuong"
                                                         cssStyle="font-weight: bold; width: 100%">
                                                <option selected disabled>Trọng Lượng</option>
                                                <form:options items="${listTrongLuong}" itemValue="id" itemLabel="ten"/>
                                            </form:select>
                                            <span class="text-danger">${errorTrongLuong}</span>
                                            <form:errors path="trongLuong"/>
                                        </div>
                                        <div class="col-1">
...
<button style="display: none" type="button" id="batmodalthemctrongluong" class="btn btn-primary" data-bs-toggle="modal"
        data-bs-target="#addTrongLuong">
    Open modal
</button>
<div class="modal" id="addTrongLuong">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body" style="color: black">
                <form:form action="/san-pham/trong-luong/add" method="post" modelAttribute="trongLuong">
                    <div class="form-group">
...
<script>
    <c:if test="${batmodalthemntrongluong==0}">
    document.getElementById('batmodalthemntrongluong').click();
    </c:if>
</script>
<script>
